    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-edit"></i> Edit Staff Information: {{ $person->name }}
                </h4>
                <div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('staff.personal.update', $person->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="blood_group" name="blood_group">
                                ...
                                <option value="A+" {{ old('blood_group', $person->blood_group) == 'A+' ? 'selected' : '' }}>A+</option>
                                <option value="A-" {{ old('blood_group', $person->blood_group) == 'A-' ? 'selected' : '' }}>A-</option>
                                <option value="B+" {{ old('blood_group', $person->blood_group) == 'B+' ? 'selected' : '' }}>B+</option>
                                <option value="B-" {{ old('blood_group', $person->blood_group) == 'B-' ? 'selected' : '' }}>B-</option>
                                <option value="AB+" {{ old('blood_group', $person->blood_group) == 'AB+' ? 'selected' : '' }}>AB+</option>
                                <option value="AB-" {{ old('blood_group', $person->blood_group) == 'AB-' ? 'selected' : '' }}>AB-</option>
                                <option value="O+" {{ old('blood_group', $person->blood_group) == 'O+' ? 'selected' : '' }}>O+</option>
                                <option value="O-" {{ old('blood_group', $person->blood_group) == 'O-' ? 'selected' : '' }}>O-</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3">{{ old('address', $person->address) }}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="emergency_contact">Emergency Contact Name</label>
                            <input type="text" class="form-control" id="emergency_contact" name="emergency_contact" 
                                   value="{{ old('emergency_contact', $person->emergency_contact) }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="staff_code" name="staff_code" 
                                   value="{{ old('staff_code', $person->staffCode ? $person->staffCode->staff_code : '') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="staff_category" name="staff_category">
                                ...
                                @foreach($categories as $key => $value)
                                    <option value="{{ $key }}" 
                                        {{ old('staff_category', $person->staffCategory ? $person->staffCategory->category : '') == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="hire_date" name="hire_date" 
                                   value="{{ old('hire_date', $person->hire_date ? $person->hire_date->format('Y-m-d') : '') }}">
                        </div>

                        <div class="form-group">
                            <label for="basic_salary">Basic Salary (Rs.)</label>
                            <input type="number" class="form-control" id="basic_salary" name="basic_salary" 
                                   min="0" step="0.01" value="{{ old('basic_salary', $person->basic_salary) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="8" 
                                      placeholder="Any additional notes about this staff member...">{{ old('notes', $person->notes) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <a href="{{ route('staff.personal.profile', $person->id) }}" class="btn btn-secondary ml-2">
