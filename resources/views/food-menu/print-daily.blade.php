...
<body>
    ...
    <div class="page">
        ...
        <div style="text-align: center; padding: 20mm; color: #6c757d;">
            <p style="font-size: 14pt;">No bookings found for this date.</p>
        </div>
    </div>
    @else
    ...
    <div class="page">
        ...
        <div class="header">
            <div class="logo-section">
                <div class="logo-icon">🍽</div>
                <div class="title-section">
                    <h1>Food Menu @if($isWedding)<span class="wedding-badge">Wedding</span>@endif</h1>
                    <div class="subtitle">{{ $date->format('l, F j, Y') }}</div>
                </div>
            </div>
            <div class="date-badge">
