    ...
    <div class="border rounded-lg shadow-md p-4 bg-white">
        ...
        <div class="mt-3 pt-3 border-t">
            <div class="food-menu-summary">
                ...
                <div class="mb-2">
                    <div class="font-semibold text-blue-700"><i class="fas fa-coffee mr-1"></i> Breakfast</div>
                ...
                <div class="mb-2">
                    <div class="font-semibold text-green-700"><i class="fas fa-hamburger mr-1"></i> Lunch</div>
                ...
                <div class="mb-2">
                    <div class="font-semibold text-orange-700"><i class="fas fa-cookie mr-1"></i> Evening Snack</div>
                ...
                <div class="mb-2">
                    <div class="font-semibold text-purple-700"><i class="fas fa-utensils mr-1"></i> Dinner</div>
