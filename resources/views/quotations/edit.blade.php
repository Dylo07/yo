            ...
            <form action="{{ route('quotations.update', $quotation) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="client_name" class="form-control @error('client_name') is-invalid @enderror" 
                                   value="{{ old('client_name', $quotation->client_name) }}" required>
                            @error('client_name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="client_address" class="form-control @error('client_address') is-invalid @enderror" 
                                      rows="3" required>{{ old('client_address', $quotation->client_address) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="schedule" class="form-control @error('schedule') is-invalid @enderror" 
                                   value="{{ old('schedule', $quotation->schedule->format('Y-m-d')) }}" required>
                            @error('schedule')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="card border-success mb-3">
                        ...
                        <div class="card-body py-2">
                            <textarea name="menu_items[welcome_drink]" class="form-control" rows="2" placeholder="e.g., Fresh Fruit Juice">{{ old('menu_items.welcome_drink', $menuItems['welcome_drink']['content'] ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card border-success mb-3">
                        ...
                        <div class="card-body py-2">
                            <textarea name="menu_items[evening_snack]" class="form-control" rows="3" placeholder="e.g., Tea and Cake Pieces & Sandwiches / Pan Cake / Fish Roll">{{ old('menu_items.evening_snack', $menuItems['evening_snack']['content'] ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card border-warning mb-3">
                        ...
                        <div class="card-body py-2">
                            <textarea name="menu_items[live_bbq]" class="form-control" rows="2" placeholder="e.g., Live BBQ Experience (5KG) with Musical Entertainment (DJ/Calipso) in Campfire Setting">{{ old('menu_items.live_bbq', $menuItems['live_bbq']['content'] ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card border-success mb-3">
                        ...
                        <div class="card-body py-2">
                            <textarea name="menu_items[bed_tea]" class="form-control" rows="2" placeholder="e.g., Tea & Kola Kanda with Hakuru (Hathawariya)">{{ old('menu_items.bed_tea', $menuItems['bed_tea']['content'] ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card border-success mb-3">
                        ...
                        <div class="card-body py-2">
                            <textarea name="menu_items[morning_snack]" class="form-control" rows="2" placeholder="e.g., Fresh Fruits / Juice / Short Eats">{{ old('menu_items.morning_snack', $menuItems['morning_snack']['content'] ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card border-info mb-3">
                        ...
                        <div class="card-body py-2">
                            <textarea name="menu_items[desserts]" class="form-control" rows="2" placeholder="e.g., Ice Cream, Melons, Pineapple, Papaya, Watalappan, Cream Caramel & Jelly">{{ old('menu_items.desserts', $menuItems['desserts']['content'] ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered" id="items-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="items[{{ $index }}][price_per_item]" class="form-control calc-input price-input" 
                                               value="{{ $item['pricePerItem'] ?? $item['price_per_item'] ?? '' }}"
                                               onchange="calculateAmount(this)">
                                    </td>
                                    <td>
                                        <input type="text" name="items[{{ $index }}][pax]" class="form-control calc-input pax-input" 
                                               value="{{ $item['pax'] ?? '' }}"
                                               onchange="calculateAmount(this)">
                                    </td>
                                    <td>
                                        <input type="text" name="items[{{ $index }}][quantity]" class="form-control calc-input qty-input" 
                                               value="{{ $item['quantity'] ?? '' }}"
                                               onchange="calculateAmount(this)">
                                    </td>
                                    <td>
                                        <input type="text" name="items[{{ $index }}][amount]" class="form-control amount-input" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="service_charge" class="form-control" 
                                   value="{{ old('service_charge', $quotation->service_charge) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="total_amount" class="form-control" 
                                   value="{{ old('total_amount', $quotation->total_amount) }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div id="comments-container">
                        ...
                        <div class="mb-2">
                            <input type="text" name="comments[]" class="form-control" value="{{ $comment }}">
                        </div>
                        @empty
                        <div class="mb-2">
...
@push('scripts')
<script>
let rowCounter = {{ count($quotation->items ?? []) }};
...
function addRow() {
    ...
    newRow.innerHTML = `
        <td>
            <input type="text" name="items[${rowCounter}][description]" class="form-control" required>
        </td>
        <td>
            <input type="text" name="items[${rowCounter}][price_per_item]" class="form-control calc-input price-input" 
                   onchange="calculateAmount(this)">
        </td>
        <td>
            <input type="text" name="items[${rowCounter}][pax]" class="form-control calc-input pax-input" 
                   onchange="calculateAmount(this)">
        </td>
        <td>
            <input type="text" name="items[${rowCounter}][quantity]" class="form-control calc-input qty-input" 
                   onchange="calculateAmount(this)">
        </td>
        <td>
            <input type="text" name="items[${rowCounter}][amount]" class="form-control amount-input" readonly>
        </td>
        <td>
            <button type="button" class="btn btn-danger btn-sm" onclick="removeRow(this)">Remove</button>
        </td>
